	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" action="./pages/ceklogin.php" method="POST">
				...
				<p>Belum Punya Akun, <a href="./pages/register.php">Klik Disini</a></p>
			</div>
		</div>
	</div>
